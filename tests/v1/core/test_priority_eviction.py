...
class TestBlockPoolPriorityEviction:
    ...
    def test_reset_prefix_cache_returns_priority_blocks_to_lru(self):
        ...
        the pool until engine restart. Observed live (2026-06-12): after a
        directive'd request + reset, usage pinned at exactly the directive
        size, any larger request waited forever, and follow-up resets
        failed with "blocks not freed"."""

...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Fraction of GPU KV-cache blocks the protected (retention) pool may
    # hold; beyond it protections degrade to plain LRU. 0 disables retention,
    # 1.0 allows the whole cache.
